...
import {
    ...
    Bottom,
    Operators,
    CDWrapper, ProgressWrapper, LyricContainer, LyricWrapper,
} from "./style";
...
function NormalPlayer(props) {
    ...
    const {toggleFullScreen, clickPlaying, onProgressChange,handlePrev, handleNext,changeMode,currentLineNum, currentPlayingLyric, currentLyric} = props;
